...
Evidence: When investigating a question, evaluating sources, synthesizing findings, or recording conflicts, read `docs/agents/research.md`.
...
Before software, design, or review work, check for applicable Matt Pocock skills and follow the human-approval rule in `docs/agents/collaboration.md` before installing any missing skill.
