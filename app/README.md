...
Agent Provider configuration is optional. The Workbench must open and support non-agentic local workflows without an API key or configured provider, while clearly reporting Agentic Capabilities as unavailable until one is configured.
