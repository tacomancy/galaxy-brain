...
| [Governance](architecture.md#governance-module) | Draft Proposals, record Judgment, and apply eligible exact-version changes through file transactions | S2 | [`app/src/modules/governance/index.ts`](../../../app/src/modules/governance/index.ts) | First S2 in-memory Proposal/Judgment/application cycle, TB8/TB9 file-backed persistence, and TB10 desktop Proposal Review application path implemented; pending-Proposal persistence and later Governance behavior remain deferred |
