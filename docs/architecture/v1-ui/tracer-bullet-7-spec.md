...
Status: preview preparation, context removal, confirmed handoff, decline/cancel preservation, and provider-unavailable handling implemented on August 27, 2026; remaining TB7 cycles are pending.
