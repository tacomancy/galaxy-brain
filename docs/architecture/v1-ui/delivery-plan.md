...
### 3. Carry context between workspaces
...
### 6. Synthesize selected evidence explicitly
...
### 8. Reject stale and incoherent applications
...
### 9. Review through the desktop interface
...
### 10. Preserve meaning across editing views
...
### 11. Separate Search, Ask, and Jump

At S4, prove one mode at a time. Start with a literal Search result, add a cited Ask answer from the known corpus, then add an unsupported Ask outcome, and finally add a known Jump command. Follow with one S1 cycle proving the selected mode is visible before execution.

### 12. Make Atlas actionable
...
### 13. Keep learning progress human-owned
...
At S3, prove that an unavailable fixture preserves the Source Record and annotations. In the next cycle, prove relinking makes the known page available without changing its logical Source Locator.

### 15. Complete the desktop quality contract
...
Pause after slices 3, 9, 12, and 15 for a green-suite review. At each checkpoint:
