...
- TB16.4–TB16.5: the packaged workflow emulates the reduced-motion preference and observes immediate workspace transitions, then verifies at 200% document zoom that the critical Studio controls remain visible, within the viewport, non-overlapping, and free of whole-application horizontal overflow.
