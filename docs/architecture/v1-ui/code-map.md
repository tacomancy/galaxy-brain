...
| [Source Processing](architecture.md#source-processing-module) | Add PDFs with a chosen Source Asset mode, capture located annotations, report availability, relink, and request Synthesis | S3 | [`app/src/modules/source-processing/index.ts`](../../../app/src/modules/source-processing/index.ts) | TB5 located source-claim capture plus TB7 preview, context removal, confirmed handoff, provider-unavailable outcome, transient result handling, default save, opt-in prompt/context snapshot, and non-blocking stale-context warning implemented; S1 confirmation UI, real provider integration, file-backed result persistence, source-status-unavailable handling, import, availability, and relinking remain deferred |
