...
Status: Tracer Bullets 1 through 7 and TB6.1–TB6.3 are complete and accepted; later tracer bullets remain unimplemented.
...
| [Governance](architecture.md#governance-module) | Draft Proposals, record Judgment, and apply eligible exact-version changes through file transactions | S2 | [`app/src/modules/governance/index.ts`](../../../app/src/modules/governance/index.ts) | First S2 in-memory Proposal/Judgment/application cycle implemented; file-backed persistence and later Governance behavior remain deferred under Tracer Bullet 8 |
...
| Workbench bridge | Narrow renderer-to-main desktop operations exposed through `contextBridge` | [`app/src/preload/workbench-bridge.ts`](../../../app/src/preload/workbench-bridge.ts) | Fresh session, repository create/open, TB4 context-transition, TB6 saved-annotation operations, and TB7 exact-preview, context-removal, confirmation, saved-result read, and restore operations implemented |
...
| Governance version storage | Deferred file-backed version, audit, and rollback Adapter | [`app/src/adapters/governance/in-memory-governance-store.ts`](../../../app/src/adapters/governance/in-memory-governance-store.ts) | S2 | First TB8 cycle supplies one seeded current version and next version ID; durable version identity, lineage, audit, rollback, and transaction behavior remain deferred to the required S5 cycle |
