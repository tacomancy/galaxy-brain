...
| [Source Processing](architecture.md#source-processing-module) | Add PDFs with a chosen Source Asset mode, capture located annotations, report availability, relink, and request Synthesis | S3 | [`app/src/modules/source-processing/index.ts`](../../../app/src/modules/source-processing/index.ts) | TB5 located source-claim capture plus TB7 preview, context removal, confirmed handoff, provider-unavailable outcome, transient result handling, default save, and opt-in prompt/context snapshot implemented; S1 confirmation UI, real provider integration, file-backed result persistence, import, availability, and relinking remain deferred |
...
| Working Material | [`app/src/adapters/working-material/file-backed-working-material-repository.ts`](../../../app/src/adapters/working-material/file-backed-working-material-repository.ts) | [`app/src/adapters/working-material/in-memory-working-material-repository.ts`](../../../app/src/adapters/working-material/in-memory-working-material-repository.ts) | S3/S5 | TB5 source-claim annotation persistence plus TB7 default saved-result and opt-in prompt/context snapshot contracts through the S3 result Adapter implemented; file-backed synthesis-result persistence remains deferred |
