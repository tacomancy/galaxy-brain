...
| [Source Processing](architecture.md#source-processing-module) | Add PDFs with a chosen Source Asset mode, capture located annotations, report availability, relink, and request Synthesis | S3 | [`app/src/modules/source-processing/index.ts`](../../../app/src/modules/source-processing/index.ts) | TB5 located source-claim capture plus TB7 preview, context removal, confirmed handoff, and provider-unavailable outcome implemented; S1 confirmation UI, real provider integration, result persistence, import, availability, and relinking remain deferred |
...
| Working Material | [`app/src/adapters/working-material/file-backed-working-material-repository.ts`](../../../app/src/adapters/working-material/file-backed-working-material-repository.ts) | [`app/src/adapters/working-material/in-memory-working-material-repository.ts`](../../../app/src/adapters/working-material/in-memory-working-material-repository.ts) | S3/S5 | TB5 source-claim annotation persistence, round-trip, and Source Record lookup implemented |
