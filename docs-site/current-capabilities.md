...
| ------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------- |
| Latest published release | [0.14.0 release notes](../app/CHANGELOG.md)                                                           | The version identified by the application package, changelog, and support policy.                                                     |
...
The latest published release is **0.14.0**. Its desktop-supported baseline is
the accepted TB1–TB7 Workbench behavior. The 0.14.0 release also contains the
