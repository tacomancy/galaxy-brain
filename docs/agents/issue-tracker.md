...
- **Child ticket**: a GitHub sub-issue linked to the map. If sub-issues are unavailable, use a task list and put `Part of #<map>` at the top of the child. Apply a `wayfinder:<type>` label.
