...
- The accepted engineering vocabulary remains authoritative in `docs/engineering/glossary.md`.
- `docs/agents/code.md` remains authoritative for TDD and confirmed Test Seams.
- `docs/agents/software-development.md` remains authoritative for language, tooling, security, and implementation conventions.
- `docs/agents/knowledge-base.md`, `docs/agents/research.md`, and `docs/agents/workbench.md` retain their specialized approval and handoff rules.
