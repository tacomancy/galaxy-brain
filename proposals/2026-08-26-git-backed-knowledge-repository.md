...
targets:
  - docs/adr/0005-use-git-and-git-lfs-for-repository-storage.md
...
- [ADR 0003](../docs/adr/0003-keep-rich-and-source-editing-equivalent.md) already requires repository text to remain portable, inspectable, and independent of the Workbench.
- Existing [knowledge-base guidance](../docs/agents/knowledge-base.md#extended-markdown) defines human-readable source constructs and requires unfamiliar extensions to be preserved.
- The [Git and Git LFS research note](../sources/web/2026-08-26-git-lfs-backend-research.md) records primary-source evidence for standard LFS pointers, committed tracking rules, separate hydration state, GitHub limits, and backup requirements.
- The accepted [Knowledge Repository seam](../docs/architecture/v1-ui/architecture.md#system-seams-and-adapters) already isolates persistence from application Modules.
...
```diff
diff --git a/docs/adr/0005-use-git-and-git-lfs-for-repository-storage.md b/docs/adr/0005-use-git-and-git-lfs-for-repository-storage.md
new file mode 100644
index 0000000..9ef384a
--- /dev/null
+++ b/docs/adr/0005-use-git-and-git-lfs-for-repository-storage.md
@@ -0,0 +1,19 @@
+---
+status: accepted
+---
...
diff --git a/docs/adr/0006-keep-knowledge-repositories-application-independent.md b/docs/adr/0006-keep-knowledge-repositories-application-independent.md
new file mode 100644
index 0000000..b6f1fed
--- /dev/null
+++ b/docs/adr/0006-keep-knowledge-repositories-application-independent.md
@@ -0,0 +1,17 @@
+---
+status: accepted
+---
...
diff --git a/docs/architecture/v1-ui/repository-format.md b/docs/architecture/v1-ui/repository-format.md
new file mode 100644
index 0000000..206e4c1
--- /dev/null
+++ b/docs/architecture/v1-ui/repository-format.md
@@ -0,0 +1,52 @@
...
index c635eb9..3d45a2e 100644
--- a/README.md
+++ b/README.md
@@ -25,0 +26,6 @@ A human-owned knowledge base for personal research and continuing education. Age
+
+## Application boundary
+
+The packaged Knowledge Workbench and each user Knowledge Repository occupy separate filesystem roots and have independent lifecycles. Updating or uninstalling the application does not move, replace, migrate, or delete the repository merely because the application version changed. User repositories conform to the versioned [Galaxy Brain Repository Format](docs/architecture/v1-ui/repository-format.md).
+
+This development repository contains application project files and fixture knowledge together for development convenience. That co-location is not the production installation model: application code, dependencies, build output, caches, indexes, credentials, and session state do not belong in a user's Knowledge Repository.
diff --git a/docs/architecture/v1-ui/README.md b/docs/architecture/v1-ui/README.md
index a21257e..c32888f 100644
--- a/docs/architecture/v1-ui/README.md
+++ b/docs/architecture/v1-ui/README.md
...
diff --git a/docs/architecture/v1-ui/architecture.md b/docs/architecture/v1-ui/architecture.md
index b71cdc5..af0902a 100644
--- a/docs/architecture/v1-ui/architecture.md
+++ b/docs/architecture/v1-ui/architecture.md
...
+
diff --git a/docs/architecture/v1-ui/code-map.md b/docs/architecture/v1-ui/code-map.md
index 1788e83..b5d5949 100644
--- a/docs/architecture/v1-ui/code-map.md
+++ b/docs/architecture/v1-ui/code-map.md
...
diff --git a/docs/agents/knowledge-base.md b/docs/agents/knowledge-base.md
index 5bb4bd1..7dd9e38 100644
--- a/docs/agents/knowledge-base.md
+++ b/docs/agents/knowledge-base.md
@@ -28,0 +29,6 @@ Use `knowledge/README.md` as the manually curated knowledge map. Create subfolde
...
+
@@ -145 +151,5 @@ Use an in-topic `Evolution` section for local changes and a linked core decision
...
+Keep replaceable generated output, caches, credentials, and machine-specific paths outside Git. Store portable Source Records with stable identifiers, canonical URLs, logical locators, and repository-held annotations.
+
...
diff --git a/templates/source.md b/templates/source.md
index a7797f5..1ba3941 100644
--- a/templates/source.md
+++ b/templates/source.md
@@ -16 +16,2 @@ citekey:
-external_locator:
+asset_mode:
+repository_asset:
