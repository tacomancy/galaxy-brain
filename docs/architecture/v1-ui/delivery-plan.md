...
- **Green evidence:** The focused TB15 suite passes all 8 tests. The complete `npm run check` gate passes formatting, linting, strict type checking, 92 Vitest tests, and documentation validation. `npm run lint:complexity` also passes.
