...
| DOC-014 | Repeated rules across project documents lacked an explicit authority map. | resolved | `app/docs/README.md` now assigns each document family a canonical responsibility and directs other documents to summarize and link. |
